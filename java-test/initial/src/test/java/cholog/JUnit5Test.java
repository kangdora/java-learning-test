...
public class JUnit5Test {
    ...
    class AssertEqualsMethodTest {
        ...
        void assertEquals_메서드로_두_객체가_같은지_비교한다() { // 이 코드는 객체의 논리적 동치성을 확인해야함.
            class LocalObject {
                ...
                public boolean equals(Object obj) {
                    ...
                    if (!(obj instanceof LocalObject) || getClass() != obj.getClass()) return false;
                    return value == ((LocalObject) obj).value;
                }
...
//            }
    ...
    class AssertDoesNotThrowMethodTest {
        ...
        void assertDoesNotThrow_메서드로_특정_예외가_발생하지_않는_것을_명시한다() {
            ...
            assertDoesNotThrow(() -> { final var number = Integer.valueOf(0x80000000);});
        }
    }
...
//            assertTrue(4 > 0 && 4 < 10);
        ...
        // @Test
        @ParameterizedTest
        @ValueSource(strings = { "a", "b", "c" }) // 이러면 각각 다 테스트해봄
        @DisplayName("ValueSource 애노테이션을 붙여 문자열 매개변수를 여러 번 입력받는다")
        void ValueSource_애노테이션을_붙여_문자열_매개변수를_여러_번_입력받는다(String str) {
...
//            assertDoesNotThrow(() -> Integer.parseInt("5"));
        ...
        void MethodSource_애노테이션을_붙여_Object_매개변수를_한_번_입력받는다(Object obj) {
            assertNotNull(obj);
        }
        ...
        void MethodSource_애노테이션을_붙여_Object_매개변수를_여러_번_입력받는다(Object obj) {
        ...
        void MethodSource_애노테이션을_붙여_정수와_문자열_매개변수를_입력받는다(String str, int number) {
            // TODO: `MethodSource`를 사용하지 않고 문자열과 정수 변수들을 직접 선언하여 테스트하는 방식과, `MethodSource`를 통해 입력받아 테스트하는 방식의 차이를 비교해보세요.
            assertEquals(Integer.parseInt(str), number);
        }
